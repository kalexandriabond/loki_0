...
if testing:
    ...
    condition = str(0)
    trialfile_n = str(0)
    exp_param_file = exp_param_directory + 'hvhc_0.csv'
else:
    ...
    if condition == 0:
        exp_param_file = exp_param_directory + 'lvlc_' + trialfile_n + '.csv'
    elif condition == 1:
        exp_param_file = exp_param_directory + 'lvhc_' + trialfile_n + '.csv'
    elif condition == 2:
        exp_param_file = exp_param_directory + 'hvlc_' + trialfile_n + '.csv'
    elif condition == 3:
        exp_param_file = exp_param_directory + 'hvhc_' + trialfile_n + '.csv'
...
rewards = 100*np.transpose(np.array([np.round(reward_t1,2),np.round(reward_t2,2)]))
